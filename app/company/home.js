  ...
  const BottomNav = () => (
    <View style={styles.bottomBar}>
      {[
        ...
        <TouchableOpacity key={route} style={[styles.navButton, active && styles.navButtonActive]} onPress={() => router.push(route)}>
          <Ionicons name={icon} size={20} color={active ? fixieColors.background : fixieColors.textSecondary} />

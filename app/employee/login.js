...
function InputRow({ icon, value, onChangeText, placeholder, secureTextEntry = false, trailingIcon, onTrailingPress }) {
  return (
...
export default function EmployeeLogin() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      await AsyncStorage.setItem("employeeID", String(data.EmployeeID));
      ...
      >
        ...
        >
          <View style={styles.switchRow}>
            <LoginSwitch label="Company" onPress={() => router.replace("/company/login")} />
          ...
          <View style={styles.form}>
            <Text style={styles.roleHeading}>Employee</Text>
            <InputRow
              icon="person-outline"
              value={username}
